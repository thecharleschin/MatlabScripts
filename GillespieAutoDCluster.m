function GillespieAutoDCluster(jobNum)
...
x0 = [0,0,0,1];
Name = sprintf('AutoDResults%g.mat',jobNum);
...
for i = 1:runs
    ...
    while T <= tMax
        ...
        a = [kM*StateON; kP*mRNA; gammam*mRNA; gammap*protein;
            kOFF*StateON; kON*StateOFF; kX*mRNA];
...
% 
% %%
% plot(tspan(1:end-1),ProteinData(:,2),'linewidth',2)
% xlabel('time')
% ylabel('<P>')
% set(gca,'fontsize',15)
% saveas(gcf,'proteintrace20.jpg')
