function GillespieAutoDepletionTFCluster(jobNum)
...
Name = sprintf('AutoDTFResults%g.mat',jobNum);
x0 = [0,0,0,0,1,1];
...
RxnMatrix = [ 1  0  0  0  0  0; %trascription
             ...
             -1 -1  1  0  0  0; %complex formation
              0  0  0 -1  1  1; %Burst OFF
              0  0  0  1 -1 -1;%Burst ON
              0  1 -1  0  0  0];%Export
...
for i = 1:runs
    ...
    while T <= tMax
        ...
        %kX = kXo/(1+(protein0/protein)^4);

        % Calculate reaction propensities
        a = [kM*StateON; kP*mRNA; gammam*mRNA; gammap*protein;
            kB*mRNA*protein; kOFF*StateON; kON*StateOFF*TF; kX*complex];
