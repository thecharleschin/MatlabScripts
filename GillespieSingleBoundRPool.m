...
kB = 1; %binding to mRNA rate
kU = ParamArray(k); %unbinding from mRNA rate
...
%GeneON GeneOFF mRNA protein  BoundRibosomes LocalRibosome GlobalRibosome
x0 = [0,1,0,0,0,0,RibosomesInitial];

RxnMatrix = [ 1 -1  0  0  0  0  0; %Burst ON
             -1  1  0  0  0  0  0; %Burst OFF
              0  0  1  0  0  0  0; %transcription
              0  0 -1  0  0  0  0; %mRNA decay
              0  0  0  0  1 -1  0; %ribosome binding
              0  0  0  0 -1  1  0; %ribosome unbinding
              0  0  0  1  0  0  0; %translation
              0  0  0 -1  0  0  0; %protein decay
              0  0  0  0  0  1 -1; %local IN
              0  0  0  0  0 -1  1];%local OUT
