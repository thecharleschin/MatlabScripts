function GillespieTLFBDirectCluster(jobNum)
...
Name = sprintf('TLFBDirectResults%g.mat',jobNum);
...
for i = 1:runs
    ...
    while T <= tMax
        ...
        a = [kM*GeneON; kP*mRNA; gammam*mRNA; gammap*protein;
            kOFF*GeneON; kON*GeneOFF; kB*GeneON*protein];
