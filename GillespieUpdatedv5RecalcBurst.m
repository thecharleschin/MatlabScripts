...
load RecalcBurstData

BurstSize = geomean(BurstSizemean,1);
BurstFreq = geomean(BurstFreqmean,1);
...
set(gca,'fontsize',15)
title('cv^2 v Abundance 2 State Burst No Empty')
saveas(gcf,'mRNAcv2vAbundance2StateRecalcBurst.jpg')
saveas(gcf,'mRNAcv2vAbundance2StateRecalcBurst.svg')
