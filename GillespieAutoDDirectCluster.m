function GillespieAutoDDirectCluster(jobNum)
...
Name = sprintf('AutoDDirectResults%g.mat',jobNum);
x0 = [0,0,0,0,1];
...
for i = 1:runs
    ...
    while T <= tMax
        ...
        a = [kM*StateON; kP*mRNA; gammam*mRNA; gammap*protein;
            kB*mRNA*protein; kOFF*StateON; kON*StateOFF; kX*complex];
